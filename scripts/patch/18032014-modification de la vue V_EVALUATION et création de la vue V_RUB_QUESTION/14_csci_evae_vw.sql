...
FROM ENSEIGNANT ENS
	...
	,CG_REF_CODES CGRC
  WHERE EVE.NO_ENSEIGNANT=ENS.NO_ENSEIGNANT AND EVE.ANNEE_PRO=PRO.ANNEE_PRO AND PRO.CODE_FORMATION=FRM.CODE_FORMATION AND UE.CODE_UE = EVE.CODE_UE AND CGRC.RV_DOMAIN='ETAT-EVALUATION'
;
